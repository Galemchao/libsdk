...
//    private static final int DEFAULT_LAME_MP3_BIT_RATE = 32;
    ...
    public void start(String filename) throws IOException {
        ...
        data.put("filename", mRecordFileName);
        mStateListener.onRecorderState("start", data);
    ...
    private void initAudioRecorder() throws IOException {
        ...
        // The thread will
        mEncodeThread = new DataEncodeThread(mRecordFileName, mBufferSize);
        mEncodeThread.setmStateListener(mStateListener);
        mEncodeThread.start();
